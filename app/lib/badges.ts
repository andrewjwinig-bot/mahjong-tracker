...
export function computeBadges(
  ...
  const list: { id: string; name: string; emoji: string; desc: string; cond: boolean }[] = [
    ...
    { id: 's_newyear', name: 'New Year', emoji: '🎆', desc: 'Finish the Winter season.', cond: seasonDone('newyear') },
    { id: 's_flowers', name: 'Flower Festival', emoji: '🌸', desc: 'Finish the Spring season.', cond: seasonDone('flowers') },
    { id: 's_summer', name: 'Summer Kongs', emoji: '☀️', desc: 'Finish the Summer season.', cond: seasonDone('summer') },
    { id: 's_dragons', name: 'Dragon Days', emoji: '🐉', desc: 'Finish the Autumn season.', cond: seasonDone('dragons') },
  ];
