...
// across the chrome. Duotone style: a soft tinted fill layer sits behind a crisp
// stroke layer, both derived from currentColor, for a premium, considered look.

import type { ReactNode } from 'react';

type P = { size?: number };

// Duotone wrapper: `fill` shapes render as a pale tint, `line` shapes as the
// crisp outline on top. Pass `fill={null}` for glyph-style line-only icons.
const D = (fill: ReactNode, line: ReactNode, size = 22) => (
...
// Solid accent glyph (sparkle / star) — reads best filled.
const Solid = (children: ReactNode, size = 22) => (
...
const bubble = <path d="M5 5h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H10l-4 3.5V15H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1z" />;

export const IconChat = ({ size }: P) => D(bubble, bubble, size);
export const IconComment = ({ size }: P) => D(bubble, bubble, size);
...
export const IconSend = ({ size }: P) =>
  D(<path d="M5 12l15-7-7 15-2.5-5.5L5 12z" />, <path d="M5 12l15-7-7 15-2.5-5.5L5 12z" />, size);

export const IconShare = ({ size }: P) =>
  D(
    <path d="M6 12v6a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-6z" />,
    <>
      <path d="M12 16V4" />
...
export const IconTrash = ({ size }: P) =>
  D(
    <path d="M6.5 7h11l-.8 11.1a1 1 0 0 1-1 .9H8.3a1 1 0 0 1-1-.9L6.5 7z" />,
    <>
      <path d="M5 7h14" />
...
const heartPath =
  'M12 20s-7-4.5-9.2-9C1.3 8 2.8 4.8 6 4.8c2 0 3.2 1.2 4 2.4.8-1.2 2-2.4 4-2.4 3.2 0 4.7 3.2 3.2 6.2C19 15.5 12 20 12 20z';

// Heart — soft duotone by default; pass `fill` for a solid (liked) heart.
export const IconHeart = ({ size = 22, fill }: P & { fill?: boolean }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden>
    <path
      d={heartPath}
      fill="currentColor"
      fillOpacity={fill ? 1 : 0.18}
      stroke="currentColor"
      strokeWidth="1.9"
      strokeLinecap="round"
...
export const IconMedal = ({ size }: P) =>
  D(
    ...
    <>
      ...
      <circle cx="12" cy="15" r="5" />
      <path d="M12 12.8l.85 1.7 1.9.28-1.38 1.34.33 1.88L12 17l-1.7.97.33-1.88-1.38-1.34 1.9-.28L12 12.8z" fill="currentColor" stroke="none" />
    </>,
    size,
  );
...
export const IconDownload = ({ size }: P) =>
  D(
    <path d="M5 14v4a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-4z" />,
    <>
      <path d="M12 4v10" />
...
export const IconSignOut = ({ size }: P) =>
  D(
    <path d="M5 5h9v14H6a1 1 0 0 1-1-1V5z" />,
    <>
...
export const IconCheck = ({ size }: P) => D(null, <path d="M5 12.5l4.5 4.5L19 7" />, size);

export const IconArrowRight = ({ size }: P) => D(null, <path d="M5 12h14M13 6l6 6-6 6" />, size);
...
const flamePath =
  'M12 3c1.5 3-1.5 4.5-1.5 7A1.5 1.5 0 0 1 8 8.5C6 10 5 12 5 14a7 7 0 0 0 14 0c0-3-2-5.5-4-7.5-1.2-1.2-2.3-2.5-3-3.5z';
export const IconFlame = ({ size }: P) => D(<path d={flamePath} />, <path d={flamePath} />, size);

export const IconTap = ({ size }: P) =>
  D(
    <path d="M15.2 10.5a1.5 1.5 0 0 1 3 0V15a5 5 0 0 1-5 5h-1.3c-1.5 0-2.6-.6-3.5-1.8L6 14.5c-.7-1 .1-2.3 1.3-2.1.6.1 1.1.4 1.7 1l.9 1V6a1.6 1.6 0 0 1 3.2 0v4.5a1.5 1.5 0 0 1 3 0z" />,
    <>
...
export const IconSparkle = ({ size }: P) =>
  Solid(<path d="M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8L12 3z" />, size);

export const IconStar = ({ size }: P) =>
  Solid(
    <path d="M12 3.5l2.6 5.3 5.9.9-4.25 4.15 1 5.85L12 17l-5.25 2.75 1-5.85L3.5 9.7l5.9-.9L12 3.5z" />,
    size,
  );
...
const palettePath =
  'M12 3.5a8.5 8.5 0 0 0 0 17c1.4 0 2-.9 2-1.8 0-.5-.2-.9-.5-1.2-.3-.3-.5-.7-.5-1.2 0-.9.8-1.6 1.7-1.6H16a4.5 4.5 0 0 0 4.5-4.5C20.5 6.6 16.7 3.5 12 3.5z';
...
const cloudPath = 'M7 18a4 4 0 0 1-.5-7.97 5 5 0 0 1 9.6-1.2A3.8 3.8 0 0 1 17.5 18H7z';
export const IconCloud = ({ size }: P) => D(<path d={cloudPath} />, <path d={cloudPath} />, size);
