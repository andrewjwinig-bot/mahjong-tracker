...
- Keep the general ledger clean and current across all properties and entities.
- Troubleshoot and resolve **out-of-balance properties**, entries posted to
  **disabled/inactive accounts**, misclassifications, and other GL anomalies.
- Prepare and post **reclassification** and correcting entries with clear
  documentation and audit trails.
- Build, maintain, and **upload monthly recurring journal entries** — and
  refresh/re-create the recurring entry schedules at the start of each year.
- Perform monthly close for each property on a disciplined schedule so books
  stay current and reconciliations never pile up. The goal is to **minimize
...
- Serve as the primary point of contact for the tax accountants, responding to
  questions and providing requested support.

### Reporting & Compliance
- Review **monthly financial reports** for each property/entity, identify
...
## Attributes That Will Make You Successful
- You keep books **current and closed on schedule** — deferred work is your pet
  peeve.
- You reconcile to the source and won't rest until a workpaper **ties out**.
- You're **tech-forward**: fast on the computer, curious about new tools, and
  open to changing a process when there's a better way.
- You communicate clearly with ownership, management, and outside tax
  professionals.
- You're self-directed and take ownership of the accuracy of the numbers.
